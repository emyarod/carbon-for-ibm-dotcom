 ...
 *
 * @element dds-lightbox-video-viewer
 * @slot title - The title content.
 * @slot description - The description content.
 */
@customElement(`${ddsPrefix}-lightbox-video-viewer`)
class DDSLightboxVideoViewer extends DDSLightboxMediaViewerBody {
  _renderDescription() {
...
export default DDSLightboxVideoViewer;
