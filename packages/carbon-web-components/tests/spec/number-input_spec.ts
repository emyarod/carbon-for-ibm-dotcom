...
const template = (props?) =>
  Default({
    [`${prefix}-number-input`]: props,
  });

describe(`${prefix}-number-input`, function () {
  ...
  describe('Rendering', function () {
    it('Should render with various attributes', async function () {
      ...
      expect(
        document.body.querySelector(`${prefix}-number-input` as any)
      ).toMatchSnapshot({
        mode: 'shadow',
      });
    });
  ...
  describe('Form validation', function () {
    ...
    beforeEach(async function () {
      ...
      await Promise.resolve();
      elem = document.body.querySelector(`${prefix}-number-input`)!;
    });
  ...
  describe('Number input specific functionality', function () {
    ...
    it('should increment values upon user gesture', async function () {
      ...
      events.on(elem, `${prefix}-number-input`, spyInput);
